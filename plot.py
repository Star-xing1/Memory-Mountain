...
class CreateMountain:
    def __init__(self):
        ...
        self.gragh = Surface3D(
            init_opts= opts.InitOpts(
                width="1080px",
                height="650px",
                page_title= "Advanced Memory mountain",
        )
        )

    def data_process(self):
        with open(r"D:\mxy\data.txt", "r") as f:
    ...
    def plot(self):
        self.data_process()
        self.gragh.add(
            series_name="Advanced Memory mountain",
            shading="realistic",
            # 通过k*k循环展开测出来的数据集
            data=self.data_set,
            ...
            title_opts=opts.TitleOpts(
                ...
                subtitle="Click here to get source of data \n Copyright@Star",
                title_link="E:/Ubuntu_64share/data_256.txt",
                pos_left="center",
                pos_right="center",
                pos_top="5%",
            ),
            ...
            )).render("Advanced Memory mountain.html")
